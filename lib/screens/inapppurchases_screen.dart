...
class GoldProducts {
  static const List<GoldProduct> all = [
    GoldProduct('32', 'Valk', 0.99),
    GoldProduct('96', 'Valk2', 2.99),
    GoldProduct('155', 'Valk4', 4.99),
    GoldProduct('189', 'Valk5', 5.99),
    GoldProduct('299', 'Valk9', 9.99),
    GoldProduct('599', 'Valk19', 19.99),
    GoldProduct('1599', 'Valk49', 49.99),
    GoldProduct('3199', 'Valk99', 99.99),
    GoldProduct('5099', 'Valk159', 159.99),
    GoldProduct('7959', 'Valk239', 239.99),
  ];
}
...
class _InAppPurchasesPageState extends State<InAppPurchasesPage> with TickerProviderStateMixin {
  ...
  Future<void> _loadGoldCoins() async {
    ...
    debugPrint('Loading street dance credits: $coins');
    setState(() {
      _goldCoins = coins;
      // 如果还没有初始化完成，在这里也设置标志
      if (!_isInitialized) {
  ...
  Future<void> _saveGoldCoins(int amount) async {
    final prefs = await SharedPreferences.getInstance();
    debugPrint('Saving street dance credits: current=$_goldCoins, adding=$amount, new=${_goldCoins + amount}');
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    if (product.amount > 0) {
      ...
      _showSnackBar("Purchase successful! +${product.amount} Street Dance Credits");
    } else {
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                '${item.amount} Street Dance Credits',
                                                style: TextStyle(
