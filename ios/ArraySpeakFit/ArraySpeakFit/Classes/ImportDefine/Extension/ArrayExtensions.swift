...
public class RouteSafeArray<Element> {
...
public extension RouteSafeArray {
    //: var first: Element? {
    var first: Element? {
        //: var result: Element?
        var result: Element?
...
public extension RouteSafeArray {
    ...
    func takeIn(where predicate: (Element)->Bool)->Element? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func stageSize(where predicate: (Element)->Bool)->Element? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func progressiveOfNext(isIncluded: @escaping (Element)->Bool) ->RouteSafeArray<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        ...
        return RouteSafeArray(array: result)
    }

    //: func index(where predicate: (Element)->Bool)-> Int? {
    func lipPhaseOfTheMoonStupidityWhere(where predicate: (Element)->Bool)-> Int? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func yesteryearFit(by areInIncreasingOrder: (Element, Element)->Bool)->RouteSafeArray<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: let result = array.sorted(by: areInIncreasingOrder)
        let result = array.sorted(by: areInIncreasingOrder)
        //: let newArray = ThreadSafeArray<Element>(array: result)
        let newArray = RouteSafeArray<Element>(array: result)
        //: pthread_rwlock_unlock(&lock)
        pthread_rwlock_unlock(&lock)
        //: return newArray
        return newArray
    ...
    func recordingMap<T>(_ transform: @escaping (Element)->T) ->[T] {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func plat<T>(_ transform: (Element)->T)->[T] {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func windowTime<T>(initialResult: T, _ nexPartialResult: @escaping (T, Element)->T)->T {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func elsewhere(_ body: (Element)->Void) {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: array.forEach(body)
        array.forEach(body)
    ...
    func smallWhere(where predicate: (Element)->Bool)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func season(_ predicate: (Element)->Bool)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
...
public extension RouteSafeArray {
    ...
    func recommendBy(_ element: Element, at index: Int) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func demineraliseUponCompletion(at index: Int, completion: ((Element)->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func gunfire(where predicate: @escaping (Element)->Bool, completion: (([Element])->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func bagTing(completion: (([Element])->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
        //: let elements = array
        let elements = array
...
public extension RouteSafeArray where Element: Equatable {
    //: func contains(_ element: Element)->Bool {
    func createer(_ element: Element)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
...
public extension RouteSafeArray {
    ...
    static func +=(left: inout RouteSafeArray, right: Element) {
        //: left.append(right)
        left.rug(right)
    }
