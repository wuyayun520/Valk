...
class BagComprehensiveBadgeLab: UILabel {
    ...
    private func loma() {
        ...
        layer.backgroundColor = UIColor.animalOf().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.concern(type: .Medium, fontSize: 11)
