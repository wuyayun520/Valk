...
extension Dictionary {
    ...
    public static func snaplinePrimary(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func mouthManage(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.snaplinePrimary(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
