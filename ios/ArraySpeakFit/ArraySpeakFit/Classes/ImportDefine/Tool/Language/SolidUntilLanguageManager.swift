...
// __CLOSE_PRINT__
//
//  SolidUntilLanguageManager.swift
//  Adjust
//
...
@objcMembers open class SolidUntilLanguageManager: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = SolidUntilLanguageManager()
    //: private(set) var currLanguage: String = ImmediatelyThen.getSystemLangCode()
    private(set) var currLanguage: String = ImmediatelyThen.activate()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func spendResistance(_ language: String) {
...
public extension NSString {
    ...
    @objc func spaceDrownInfluential() -> String {
...
extension String {
    ...
    public func launchRid(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let language = SolidUntilLanguageManager.shared.currLanguage
        //: let languageFolder = SVGAEffectTool.default.languagePath
        let languageFolder = EffectTool.default.languagePath
