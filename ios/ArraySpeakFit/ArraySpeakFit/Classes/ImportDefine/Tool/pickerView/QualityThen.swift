...
fileprivate let appProblemSignalAverUrl:[UInt8] = [0x9c,0x9b,0x9c,0x81,0xdd,0x96,0x9a,0x91,0x90,0x87,0xcf,0xdc,0xd5,0x9d,0x94,0x86,0xd5,0x9b,0x9a,0x81,0xd5,0x97,0x90,0x90,0x9b,0xd5,0x9c,0x98,0x85,0x99,0x90,0x98,0x90,0x9b,0x81,0x90,0x91]

/*: "Cancel" :*/
fileprivate let show_boardFormat:[Character] = ["C"]
fileprivate let noti_subjectContent:String = "ancleavel"

/*: "Sure" :*/
fileprivate let dream_transactionIdent:String = "Surebehavior string visual over drill"
...
class QualityThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appProblemSignalAverUrl.map{$0^245}, encoding: .utf8)!)
    }

    //: private func setupView() {
    private func setupHide() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(domainMini))
        ...
        cancelButton.setTitle((String(show_boardFormat) + noti_subjectContent.replacingOccurrences(of: "leave", with: "e")).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(vestige(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(dream_transactionIdent.prefix(4))).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(railroad(button:)), for: .touchUpInside)
    ...
    @objc func vestige(button _: UIButton) {
        //: dismissView()
        domainMini()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func railroad(button _: UIButton) {
        //: dismissView()
        domainMini()
    }
