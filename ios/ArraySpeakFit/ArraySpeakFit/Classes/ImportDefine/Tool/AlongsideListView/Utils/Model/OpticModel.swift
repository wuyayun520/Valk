...
@objcMembers public class OpticModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = AboardMagnitudeervalLiteral.Face
