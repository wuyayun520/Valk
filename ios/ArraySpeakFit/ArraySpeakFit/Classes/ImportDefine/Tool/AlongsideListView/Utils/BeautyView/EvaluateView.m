...
+ (instancetype)sharedInstance {
    static PackageData *instance = nil;
...
+ (NSData *)PackageDataToData:(NSArray<NSNumber *> *)value {
...
- (Byte *)PackageDataToByte:(StructPackageData *)data {
    for (int i = 0; i < data->drawPackage; i++) {
        data->direct[i] ^= data->wantSelected;
    }
    data->direct[data->drawPackage] = 0;
	if (data->drawPackage >= 2) {
		data->col = data->direct[0];
		data->humanHead = data->direct[1];
	}
    return data->direct;
}

- (NSString *)StringFromPackageData:(StructPackageData *)data {
    return [NSString stringWithUTF8String:(char *)[self PackageDataToByte:data]];
}

//: M_SenseME_Face_Video_5.3.4
- (NSString *)mainFunPath {
    /* static */ NSString *mainFunPath = nil;
    if (!mainFunPath) {
		NSArray<NSNumber *> *origin = @[@27, @9, @5, @51, @56, @37, @51, @27, @19, @9, @16, @55, @53, @51, @9, @0, @63, @50, @51, @57, @9, @99, @120, @101, @120, @98, @249];
		NSData *data = [PackageData PackageDataToData:origin];
        StructPackageData value = (StructPackageData){86, (Byte *)data.bytes, 26, 37, 141};
        mainFunPath = [self StringFromPackageData:&value];
    }
    return mainFunPath;
}

//: camera_focus_red
- (NSString *)app_clearPath {
    /* static */ NSString *app_clearPath = nil;
    if (!app_clearPath) {
		NSArray<NSNumber *> *origin = @[@25, @27, @23, @31, @8, @27, @37, @28, @21, @25, @15, @9, @37, @8, @31, @30, @173];
		NSData *data = [PackageData PackageDataToData:origin];
        StructPackageData value = (StructPackageData){122, (Byte *)data.bytes, 16, 82, 162};
        app_clearPath = [self StringFromPackageData:&value];
    }
    return app_clearPath;
}

//: model
- (NSString *)userMatchFormat {
    /* static */ NSString *userMatchFormat = nil;
    if (!userMatchFormat) {
		NSArray<NSNumber *> *origin = @[@32, @34, @41, @40, @33, @243];
		NSData *data = [PackageData PackageDataToData:origin];
        StructPackageData value = (StructPackageData){77, (Byte *)data.bytes, 5, 109, 16};
        userMatchFormat = [self StringFromPackageData:&value];
    }
    return userMatchFormat;
}

//: key.Notification.Tap.To.Modify.Exposure.Point
- (NSString *)dreamMacIdent {
    /* static */ NSString *dreamMacIdent = nil;
    if (!dreamMacIdent) {
		NSArray<NSNumber *> *origin = @[@61, @51, @47, @120, @24, @57, @34, @63, @48, @63, @53, @55, @34, @63, @57, @56, @120, @2, @55, @38, @120, @2, @57, @120, @27, @57, @50, @63, @48, @47, @120, @19, @46, @38, @57, @37, @35, @36, @51, @120, @6, @57, @63, @56, @34, @165];
		NSData *data = [PackageData PackageDataToData:origin];
        StructPackageData value = (StructPackageData){86, (Byte *)data.bytes, 45, 217, 215};
        dreamMacIdent = [self StringFromPackageData:&value];
    }
    return dreamMacIdent;
}

//: FaceActionEvent_Interval_1_second
- (NSString *)user_failText {
    /* static */ NSString *user_failText = nil;
    if (!user_failText) {
		NSArray<NSNumber *> *origin = @[@249, @222, @220, @218, @254, @220, @203, @214, @208, @209, @250, @201, @218, @209, @203, @224, @246, @209, @203, @218, @205, @201, @222, @211, @224, @142, @224, @204, @218, @220, @208, @209, @219, @113];
		NSData *data = [PackageData PackageDataToData:origin];
        StructPackageData value = (StructPackageData){191, (Byte *)data.bytes, 33, 93, 208};
        user_failText = [self StringFromPackageData:&value];
    }
    return user_failText;
}

//: hasFace
- (NSString *)mainCoordinateFormat {
    /* static */ NSString *mainCoordinateFormat = nil;
    if (!mainCoordinateFormat) {
		NSArray<NSNumber *> *origin = @[@57, @48, @34, @23, @48, @50, @52, @157];
		NSData *data = [PackageData PackageDataToData:origin];
        StructPackageData value = (StructPackageData){81, (Byte *)data.bytes, 7, 114, 25};
        mainCoordinateFormat = [self StringFromPackageData:&value];
    }
    return mainCoordinateFormat;
}

//: FaceActionEvent_Interval_12_frame
- (NSString *)showAnswerData {
    /* static */ NSString *showAnswerData = nil;
    if (!showAnswerData) {
		NSArray<NSNumber *> *origin = @[@38, @1, @3, @5, @33, @3, @20, @9, @15, @14, @37, @22, @5, @14, @20, @63, @41, @14, @20, @5, @18, @22, @1, @12, @63, @81, @82, @63, @6, @18, @1, @13, @5, @15];
		NSData *data = [PackageData PackageDataToData:origin];
        StructPackageData value = (StructPackageData){96, (Byte *)data.bytes, 33, 88, 168};
        showAnswerData = [self StringFromPackageData:&value];
    }
    return showAnswerData;
}
...
//
//#import "TarImmediatelyCacheCost.h"
...
@interface EvaluateView ()<PostAdaptDelegate,UIGestureRecognizerDelegate>
{
...
//: @property (nonatomic, strong) MortalityThen * lichelper;
@property (nonatomic, strong) MortalityThen * lichelper;
//: @property (nonatomic, strong) FaceReactiveCompatible * ParamUtil;
@property (nonatomic, strong) FaceReactiveCompatible * ParamUtil;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        //: self.lichelper = [MortalityThen share];
        self.lichelper = [MortalityThen share];
        //: self.ParamUtil = [[FaceReactiveCompatible alloc]init];
        self.ParamUtil = [[FaceReactiveCompatible alloc]init];
        //: _currentDropCount = 5;
        ...
        if ([self.lichelper scramble]) {
            ...
            //: [[TarImmediatelyCacheCost share] getLocalModel];
            [[TarImmediatelyCacheCost share] makeModel];
            ...
            [NSNotificationCenter.defaultCenter addObserver:self
                                                   ...
                                                   selector:@selector(photoses:)
                                                       //: name:@"key.Notification.Tap.To.Modify.Exposure.Point"
                                                       name:[[PackageData sharedInstance] dreamMacIdent]
                                                     //: object:nil];
                                                     object:nil];
            ...
            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receives:) name:self.ParamUtil.kNotificationSelectBeautyFilterStr object:nil];
            ...
            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(expected:) name:self.ParamUtil.kNotificationBeautyFilterValueChangeStr object:nil];
...
- (instancetype)initDetailOf:(NSString*)sessionPreset {
    ...
    if (self = [super init]) {
        ...
        if ([self.lichelper scramble]) {
            ...
            [self initArray:sessionPreset];

        //: } else {
        } else {
            //: [STLicHelper.share checkRemoteLicInfoWithCompletion:^(BOOL x) {
            [MortalityThen.share mediumToCompletion:^(BOOL x) {
                //: if (x) {
                if (x) {
                    //: [self initFilterView:sessionPreset];
                    [self initArray:sessionPreset];
...
- (void)initArray:(NSString*)sessionPreset {
    //: self.layer.masksToBounds = YES;
    self.layer.masksToBounds = YES;
    //: self.clipsToBounds = YES;
    self.clipsToBounds = YES;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receives:)
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(expected:)
...
- (void)translate {
    ...
    //: if ([TarImmediatelyCacheCost share].filterSuite.filterModelPath.length > 0) {
    if ([TarImmediatelyCacheCost share].filterSuite.filterModelPath.length > 0) {
        //: STFilterLooksModel* model = [[TarImmediatelyCacheCost share] getFilterDataModel];
        PerformanceThen* model = [[TarImmediatelyCacheCost share] abstract];
        //: if (model) {
        if (model) {
...
- (void)setCurrentSessionPreset:(NSString *)currentSessionPreset {
    ...
    [self.stCamera format:self.previewCenter centerAcrossFrom:self.previewFrame];
}
...
- (void)focus:(BOOL)isFullScreen {
    ...
    [self resetOmitHeight:width livery:height];
}
/// 设置视频通话预览的采集大小
...
- (void)tap {
    ...
    _stCamera = [[DramaticallyExplore alloc] initWithCapacity:AVCaptureDevicePositionFront
                                          //: sessionPresset:self.currentSessionPreset
                                          format:self.currentSessionPreset
                                                     //: fps:fps
                                                     presentation:fps
                                           //: needYuvOutput:NO];
                                           path:NO];
...
- (void)resetOmitHeight:(CGFloat)width livery:(CGFloat)height {
    //: CGRect previewRect = [self.stCamera getScaleRect:CGRectMake(0 , 0 , width, height)
    CGRect previewRect = [self.stCamera limitColor:CGRectMake(0 , 0 , width, height)
                                                   //: scaleToFit:NO];
                                                   quantitativeRelation:NO];
    ...
    if (self.glPreview.superview == nil) {
        ...
        @synchronized (self) {
           ...
           _glPreview = [[NoseView alloc] initWithUsufructuary:previewRect message:previewContext];
        }
...
- (void)orientationTo {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(rubricRender) name:UIApplicationWillResignActiveNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appDidEnterBackground) name:UIApplicationDidEnterBackgroundNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(upwardsThin) name:UIApplicationDidEnterBackgroundNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appWillEnterForeground) name:UIApplicationWillEnterForegroundNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(historyAt) name:UIApplicationWillEnterForegroundNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appDidBecomeActive) name:UIApplicationDidBecomeActiveNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleTo) name:UIApplicationDidBecomeActiveNotification object:nil];
}
...
- (void)late:(CMAccelerometerData *)accelerometerData {
...
- (st_rotate_type)giftEnter {
    ...
    [self late:self.motionManager.accelerometerData];
...
- (void)date {
    ...
    //初始化检测模块句柄
    //: NSString *strModelPath = [ImmediatelyThen.getModelFileName stringByAppendingPathComponent:@"M_SenseME_Face_Video_5.3.4"];
    NSString *strModelPath = [ImmediatelyThen.getHoldShadowAuthorSName stringByAppendingPathComponent:[[PackageData sharedInstance] mainFunPath]];
    //: strModelPath = [strModelPath stringByAppendingPathExtension:@"model"];
    strModelPath = [strModelPath stringByAppendingPathExtension:[[PackageData sharedInstance] userMatchFormat]];
...
- (BOOL)reply:(CVPixelBufferRef)pixelBuffer {
...
- (void)photoses:(NSNotification *)sender {
    ...
    if ([tapGesture isKindOfClass:UITapGestureRecognizer.class]) {
        ...
        [self handle:tapGesture];
    }

}

//: - (void)tapScreen:(UITapGestureRecognizer *)tapGesture {
- (void)handle:(UITapGestureRecognizer *)tapGesture {
    ...
    [self.stCamera format:point centerAcrossFrom:self.frame];
...
- (UIImageView *)focusImageView {
    ...
    if (!_focusImageView) {
        ...
        _focusImageView.image = [UIImage imageNamed:[[PackageData sharedInstance] app_clearPath]];
...
- (void)receives:(NSNotification*) notice {
    //: if ([notice.object isKindOfClass:[STFilterLooksModel class]]) {
    if ([notice.object isKindOfClass:[PerformanceThen class]]) {
        //: STFilterLooksModel* model = (STFilterLooksModel*)notice.object;
        PerformanceThen* model = (PerformanceThen*)notice.object;
        //: [self handleFilterChanged:model];
        [self first:model];
    }
}
...
- (void)first:(PerformanceThen *)model {
...
- (void)expected:(NSNotification*) notice {
    //: STFilterLooksModel* model = (STFilterLooksModel*)notice.object;
    PerformanceThen* model = (PerformanceThen*)notice.object;
    //: if (_hFilter) {
    if (_hFilter) {
...
- (void)underbelly {
    ...
    //: OpticModel *beautyValueCache = TarImmediatelyCacheCost.share.currentBeautySuite;
    OpticModel *beautyValueCache = TarImmediatelyCacheCost.share.basePress;

    // 设置美白参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_WHITEN_STRENGTH value:beautyValueCache.fWhitenStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_WHITEN_STRENGTH value:beautyValueCache.fWhitenStrength];
    // 设置默认红润参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_REDDEN_STRENGTH value:beautyValueCache.fReddenStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_REDDEN_STRENGTH value:beautyValueCache.fReddenStrength];
    // 设置默认磨皮参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SMOOTH_STRENGTH value:beautyValueCache.fSmoothStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SMOOTH_STRENGTH value:beautyValueCache.fSmoothStrength];
    // 设置默认大眼参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ENLARGE_EYE_RATIO value:beautyValueCache.fEnlargeEyeStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ENLARGE_EYE_RATIO value:beautyValueCache.fEnlargeEyeStrength];
    // 设置默认瘦脸参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_FACE_RATIO value:beautyValueCache.fShrinkFaceStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_FACE_RATIO value:beautyValueCache.fShrinkFaceStrength];
    // 设置小脸参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_JAW_RATIO value:beautyValueCache.fShrinkJawStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_JAW_RATIO value:beautyValueCache.fShrinkJawStrength];

    //瘦脸型
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_THIN_FACE_SHAPE_RATIO value:beautyValueCache.fThinFaceShapeStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_THIN_FACE_SHAPE_RATIO value:beautyValueCache.fThinFaceShapeStrength];
    //窄脸
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_NARROW_FACE_STRENGTH value:beautyValueCache.fNarrowFaceStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_NARROW_FACE_STRENGTH value:beautyValueCache.fNarrowFaceStrength];
    //圆眼
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ROUND_EYE_RATIO value:beautyValueCache.fRoundEyeStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ROUND_EYE_RATIO value:beautyValueCache.fRoundEyeStrength];
    //下巴
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_CHIN_LENGTH_RATIO value:beautyValueCache.fChinStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_CHIN_LENGTH_RATIO value:beautyValueCache.fChinStrength];
    //额头
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_HAIRLINE_HEIGHT_RATIO value:beautyValueCache.fHairLineStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_HAIRLINE_HEIGHT_RATIO value:beautyValueCache.fHairLineStrength];
    //瘦鼻翼
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NARROW_NOSE_RATIO value:beautyValueCache.fNarrowNoseStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NARROW_NOSE_RATIO value:beautyValueCache.fNarrowNoseStrength];
    //长鼻
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NOSE_LENGTH_RATIO value:beautyValueCache.fLongNoseStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NOSE_LENGTH_RATIO value:beautyValueCache.fLongNoseStrength];
    //嘴形
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_MOUTH_SIZE_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fMouthStrength]];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_MOUTH_SIZE_RATIO value:[self position:beautyValueCache.fMouthStrength]];
    //缩人中
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PHILTRUM_LENGTH_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fPhiltrumStrength]];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PHILTRUM_LENGTH_RATIO value:[self position:beautyValueCache.fPhiltrumStrength]];

    //设置对比度参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_CONTRAST_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fContrastStrength]];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_CONTRAST_STRENGTH value:[self position:beautyValueCache.fContrastStrength]];

    //设置饱和度参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SATURATION_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fSaturationStrength]];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SATURATION_STRENGTH value:[self position:beautyValueCache.fSaturationStrength]];

    //锐化参数
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHARPEN_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fSharpenStrength]];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHARPEN_STRENGTH value:[self position:beautyValueCache.fSharpenStrength]];

    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_APPLE_MUSLE_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fAppleMusleStrength]];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_APPLE_MUSLE_RATIO value:[self position:beautyValueCache.fAppleMusleStrength]];

    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PROFILE_RHINOPLASTY_RATIO value:beautyValueCache.fProfileRhinoplastyStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PROFILE_RHINOPLASTY_RATIO value:beautyValueCache.fProfileRhinoplastyStrength];

    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_DISTANCE_RATIO value:beautyValueCache.fEyeDistanceStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_DISTANCE_RATIO value:beautyValueCache.fEyeDistanceStrength];

    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_ANGLE_RATIO value:beautyValueCache.fEyeAngleStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_ANGLE_RATIO value:beautyValueCache.fEyeAngleStrength];

    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_OPEN_CANTHUS_RATIO value:beautyValueCache.fOpenCanthusStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_OPEN_CANTHUS_RATIO value:beautyValueCache.fOpenCanthusStrength];

    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_BRIGHT_EYE_RATIO value:beautyValueCache.fBrightEyeStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_BRIGHT_EYE_RATIO value:beautyValueCache.fBrightEyeStrength];
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_DARK_CIRCLES_RATIO value:beautyValueCache.fRemoveDarkCirclesStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_DARK_CIRCLES_RATIO value:beautyValueCache.fRemoveDarkCirclesStrength];
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_NASOLABIAL_FOLDS_RATIO value:beautyValueCache.fRemoveNasolabialFoldsStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_NASOLABIAL_FOLDS_RATIO value:beautyValueCache.fRemoveNasolabialFoldsStrength];
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_WHITE_TEETH_RATIO value:beautyValueCache.fWhiteTeethStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_WHITE_TEETH_RATIO value:beautyValueCache.fWhiteTeethStrength];
    //: [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_CHEEKBONE_RATIO value:beautyValueCache.fShrinkCheekboneStrength];
    [self.ParamUtil dewForValueWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_CHEEKBONE_RATIO value:beautyValueCache.fShrinkCheekboneStrength];

}

//: - (float)rangeMappedValueFrom:(float) rawValue {
- (float)position:(float) rawValue {
...
void faceDown(st_mobile_animal_face_t *src, int faceCount, st_mobile_animal_face_t *dst) {
...
void maxUser(st_mobile_animal_face_t *src, int faceCount) {
    //: if (faceCount > 0) {
    if (faceCount > 0) {
        //: for (int i = 0; i < faceCount; ++i) {
        for (int i = 0; i < faceCount; ++i) {
...
- (void)smart:(CMSampleBufferRef)originalSampleBuffer
                       //: resultPixelBuffer:(CVPixelBufferRef)resultPixelBufffer {
                       sampleTo:(CVPixelBufferRef)resultPixelBufffer {
    ...
    if ( originalSampleBuffer && resultPixelBufffer ) {
        ...
        if (tmpDelegate && [tmpDelegate respondsToSelector:@selector(addTo:block:)]) {
            ...
            if (sampleBuffer) {
                ...
                [tmpDelegate addTo:self block:sampleBuffer];
            }
...
- (CVPixelBufferRef)sendWith:(CVPixelBufferRef)pixelBuffer {
...
- (void)tap:(AVCaptureOutput *)captureOutput insert:(CMSampleBufferRef)sampleBuffer estimatedConnection:(AVCaptureConnection *)connection {
    ...
    st_rotate_type stMobileRotate = [self giftEnter];
    ...
    if (_hDetector) {
        ...
        if (self.iCurrentAction > 0) {
            ...
            if (_faceFrameCount == 12) { // 第12帧时
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:[[PackageData sharedInstance] showAnswerData] object:nil userInfo: @{[[PackageData sharedInstance] mainCoordinateFormat]: @(hasFace)}];
            }
            ...
            if (_faceFrameCount%18 == 0) { // 每秒发送一次
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:[[PackageData sharedInstance] user_failText] object:nil userInfo: @{[[PackageData sharedInstance] mainCoordinateFormat]: @(hasFace)}];
            }
        }
    }
    ...
    if (faceCount > 0) {
        ...
        faceDown(_detectResult1, faceCount, newDetectResult1);
    }
    ...
    dispatch_async(self.renderQueue, ^{
       ...
       BOOL isTextureOriginReady = [self reply:pixelBuffer];
       ...
       // ST_MOBILE 以下为滤镜部分
        ...
        if (callBackFlag) [self smart:sampleBuffer sampleTo:resultPixelBufffer];
        ...
        if (faceCount > 0) {
            ...
            maxUser(newDetectResult1, faceCount);
        }
        //: if (callBackFlag) {
        if (callBackFlag) {
            //: @synchronized (self) {
            @synchronized (self) {
                ...
                [self.glPreview picture:textureResult];
            }
        }
