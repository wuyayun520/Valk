...
class MessageBeautyViewLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        layoutContentSize = CGSize(width: Int(kGiftIdent) * page, height: 2*GiftItemHeight)
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let x = page * Int(kGiftIdent) + pageCol * (itemWidth )
