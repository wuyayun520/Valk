...
fileprivate let dream_variationIdent:String = "recent enable ret dismissbtn_m"
fileprivate let noti_birdMessage:[Character] = ["_","c","o","n","t","i","n","u","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let dreamWithinFormat:[UInt8] = [0xd9,0xde,0xd9,0xe4,0x98,0xd3,0xdf,0xd4,0xd5,0xe2,0xaa,0x99,0x90,0xd8,0xd1,0xe3,0x90,0xde,0xdf,0xe4,0x90,0xd2,0xd5,0xd5,0xde,0x90,0xd9,0xdd,0xe0,0xdc,0xd5,0xdd,0xd5,0xde,0xe4,0xd5,0xd4]

fileprivate func incommunicativeInvest(submit num: UInt8) -> UInt8 {
...
class CommunicateAlertView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(leftHandedTopAngleClick), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(accompany), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: SeeAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(dream_variationIdent.suffix(5)) + "e_back" + String(noti_birdMessage))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dreamWithinFormat.map{incommunicativeInvest(submit: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func backVisual(title: String, isTouch: Bool) {
