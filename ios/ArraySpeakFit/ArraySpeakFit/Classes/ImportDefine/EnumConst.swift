...
enum FamilyAdditiveArithmetic: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum BridgeTitleLiteral: String {
    //: case AppleLogin
...
enum PeopleCustomReflectable: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum AlongsideDigitalTableConvertible: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum DemandStuffTextConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum PhysicalTitleConvertible: Int {
    //: case isOnGoing = 0
...
@objc public enum NetworkNameConvertible: Int {
    //: case Unavailable = 0
...
enum UsufructuaryCaseIterable: CaseIterable {
...
enum PerformanceMagnitudeLiteral: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
