...
struct BagHandyJSON: HandyJSON {
    ...
    var momentPic: ActivityModelType?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [ValueAttemptGalleryModel]? // 相册
    ...
    var aiExtraInfo = MessageInfoModel() // AI模型
    //: var vipSkinId = 0
...
struct ActivityModelType: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [SayTransformable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct SayTransformable: HandyJSON {
...
struct ValueAttemptGalleryModel: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func currency(compareTo: ValueAttemptGalleryModel) -> Bool {
        //: return
        return
...
enum FaceHashableRepresentation: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
