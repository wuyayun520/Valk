...
/*: "Face verification" :*/
fileprivate let showPrepareName:String = "Face vprevious change"
fileprivate let app_shirtName:String = "tscrambleon"
...
// __CLOSE_PRINT__
//
//  CountegrityViewController.swift
//  AbroadTalking
//
...
class CountegrityViewController: FictionalCharacterRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        title = (String(showPrepareName.prefix(6)) + "erifica" + app_shirtName.replacingOccurrences(of: "scramble", with: "i")).localized
        //: self.createUI()
        self.adjustUi()
    ...
    lazy var mainView: RelatedReactiveCompatible = {
        //: let view = TalkingVerificationExampleView()
        let view = RelatedReactiveCompatible()
        //: return view
        return view
        //: }()
    }()
...
extension CountegrityViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    //: private func takePhoto() {
    private func flushBeauty() {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = LifePeopleControllerDelegate(photoImage: photo)
...
extension CountegrityViewController {
    ...
    func adjustUi() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            SatelliteThen.alongEach(true) { isOpen in
