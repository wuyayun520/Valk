...
/*: "Game Center" :*/
fileprivate let noti_concentrationTitle:String = "Game Centhello below"
fileprivate let k_mobileFormat:String = "ebond"

/*: "You've got no list yet." :*/
fileprivate let showProgressTitle:String = "You\'ve g"
fileprivate let m_cellMessage:[Character] = ["o","t"," ","n","o"," ","l","i"]
fileprivate let noti_currentUrl:String = "st yet.pack the"

/*: "list" :*/
fileprivate let user_hamFormat:String = "lcomplaintt"
...
class CapacityDataSource: FictionalCharacterRecognizerDelegate {
    //: override func viewDidLoad() {
    override func viewDidLoad() {
        //: super.viewDidLoad()
        super.viewDidLoad()
        //: self.title = "Game Center".localized
        self.title = (String(noti_concentrationTitle.prefix(9)) + k_mobileFormat.replacingOccurrences(of: "bond", with: "r")).localized
        //: setupSubviews()
        generate()
    ...
    private lazy var emptyView: EmptyView = {
        ...
        style.TipsTitle = (showProgressTitle + String(m_cellMessage) + String(noti_currentUrl.prefix(7))).localized
...
extension CapacityDataSource {
    ...
    private func nearSingleShade() {
        ...
        CryRequestTool.suspend(category: 1) { [weak self] _, result, _ in
            ...
            json[(user_hamFormat.replacingOccurrences(of: "complaint", with: "is"))].arrayObject?.forEach { dict in
...
extension CapacityDataSource: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.changeColor(model: dataArr[indexPath.row], nameColor: .telecom())
        //: return cell
        return cell
    }
