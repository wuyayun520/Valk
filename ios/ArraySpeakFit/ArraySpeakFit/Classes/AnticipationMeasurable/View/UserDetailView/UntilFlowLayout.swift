...
fileprivate let noti_putOperateMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Gifts received" :*/
fileprivate let notiLightData:String = "Gifts recher leading ignore curve"
fileprivate let kFemaleStr:[Character] = ["e","i","v","e","d"]
...
class UntilFlowLayout: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_putOperateMsg.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(notiLightData.prefix(9)) + String(kFemaleStr)).localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(DamnView.self, forCellWithReuseIdentifier: DamnView.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension UntilFlowLayout: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: DamnView.className(), for: indexPath) as! DamnView
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: AnticipationMeasurable = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.live(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }
...
extension UntilFlowLayout {
    //: private func setupSubviews() {
    private func circleRoute() {
