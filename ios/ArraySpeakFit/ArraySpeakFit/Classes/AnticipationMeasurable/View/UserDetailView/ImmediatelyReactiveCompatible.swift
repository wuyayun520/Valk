...
// __CLOSE_PRINT__
//
//  ImmediatelyReactiveCompatible.swift
//  AbroadTalking
//
...
protocol LayoutObjectProtocol: NSObjectProtocol {
...
class ImmediatelyReactiveCompatible: UICollectionViewFlowLayout {
    //: var delegate: TalkingTagCollectionFlowLayoutDelegate?
    var delegate: LayoutObjectProtocol?
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for i in 1..<attributes.count {
            ...
            if i == attributes.count-1 {
                ...
                self.delegate?.layoutH(layoutH: curAttr.frame.maxY)
            }
        }
