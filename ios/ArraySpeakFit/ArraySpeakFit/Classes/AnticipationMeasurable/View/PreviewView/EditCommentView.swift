...
fileprivate let main_bindIdent:[UInt8] = [0xd2,0xd5,0xd2,0xcf,0x93,0xd8,0xd4,0xdf,0xde,0xc9,0x81,0x92,0x9b,0xd3,0xda,0xc8,0x9b,0xd5,0xd4,0xcf,0x9b,0xd9,0xde,0xde,0xd5,0x9b,0xd2,0xd6,0xcb,0xd7,0xde,0xd6,0xde,0xd5,0xcf,0xde,0xdf]
...
class EditCommentView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.mediaEarlyListener()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: main_bindIdent.map{$0^187}, encoding: .utf8)!)
    }
    ...
    lazy var contentLabel = UILabel().then {
        ...
        $0.font = .concern(type: .Regular, fontSize: 16)
    }
}
...
extension EditCommentView {
    //: private func bindInteraction() {
    private func mediaEarlyListener() {}
}
...
extension EditCommentView {
    ...
    func yesterdayCriticize(content: String) {
        ...
        if content.isEmptyString {
            ...
            let attributes = [.foregroundColor: UIColor.white, .font: UIFont.concern(type: .Regular, fontSize: 16)] as [NSAttributedString.Key: Any]
