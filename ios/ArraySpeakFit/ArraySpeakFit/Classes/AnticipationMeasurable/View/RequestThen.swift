...
fileprivate let show_peerValue:[UInt8] = [0x78,0x7d,0x78,0x83,0x37,0x72,0x7e,0x73,0x74,0x81,0x49,0x38,0x2f,0x77,0x70,0x82,0x2f,0x7d,0x7e,0x83,0x2f,0x71,0x74,0x74,0x7d,0x2f,0x78,0x7c,0x7f,0x7b,0x74,0x7c,0x74,0x7d,0x83,0x74,0x73]

fileprivate func butterflyTruly(cost num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let mainLovelyValue:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]

/*: "Add" :*/
fileprivate let k_textureData:String = "bring moon fireAdd"
...
class RequestThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_peerValue.map{butterflyTruly(cost: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.verbalDescription(name: (String(mainLovelyValue))))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.componentHighlight()
        //: lb.textAlignment = .right
        lb.textAlignment = .right
        //: lb.text = "Add".localized
        lb.text = (String(k_textureData.suffix(3))).localized
        //: lb.isHidden = true
        lb.isHidden = true
        //: return lb
        return lb
...
extension RequestThen {
    ...
    func schedule(titile: String, iconStr: String, isShowDet: Bool) {
        //: titleBLB.text = titile
        titleBLB.text = titile
        //: iconImg.image = UIImage.BundleImageNamed(name: iconStr)
        iconImg.image = UIImage.verbalDescription(name: iconStr)
