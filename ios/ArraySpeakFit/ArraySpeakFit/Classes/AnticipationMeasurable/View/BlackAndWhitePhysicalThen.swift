...
fileprivate let kCheerName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#333333" :*/
fileprivate let dreamDelayWelcomeUrl:[Character] = ["#","3","3","3","3","3","3"]

/*: "My photos" :*/
fileprivate let showDetailedId:[Character] = ["M","y"," ","p","h","o","t","o","s"]

/*: "#999999" :*/
fileprivate let noti_mustStr:String = "#9999"
fileprivate let mainFailFormat:String = "inputinput"

/*: "Click to change or delete photo." :*/
fileprivate let dreamSuperiorKeyFormat:[UInt8] = [0x72,0x9b,0x98,0x92,0x9a,0x4f,0xa3,0x9e,0x4f,0x92,0x97,0x90,0x9d,0x96,0x94,0x4f,0x9e,0xa1,0x4f,0x93,0x94,0x9b,0x94,0xa3,0x94,0x4f,0x9f,0x97,0x9e,0xa3,0x9e,0x5d]

fileprivate func pokeTear(size num: UInt8) -> UInt8 {
...
fileprivate let noti_presentTitle:[Character] = ["b","t","n","_","m","e","_","e","d","i"]
fileprivate let mainLabUrl:String = "t_phwhole support successfully min"
fileprivate let app_formerGlobalTemplateId:String = "add_norposition food surgery component"

/*: "btn_me_edit_photo_add_pre" :*/
fileprivate let user_rationalFormat:String = "utilize intobtn_me_"
fileprivate let mDistantData:[Character] = ["e"]
fileprivate let showSimultaneouslyUrl:String = "multiple simply audience accessdit_p"
fileprivate let app_followStandardData:String = "add_pretone agree spring exception"

/*: "btn_me_edit_photo_delete" :*/
fileprivate let app_darkData:String = "center design production bottom pearbtn_me"
fileprivate let m_wayName:String = "PHOTO"
fileprivate let showCalculateMessage:String = "_deleteconstitute perfect double exhibit very"
...
// __CLOSE_PRINT__
//
//  BlackAndWhitePhysicalThen.swift
//  AbroadTalking
//
...
public protocol StopPhotoDelegate: NSObject {
    /// 图片add
...
class BlackAndWhitePhysicalThen: UITableViewCell {
    //: let disposeBag = DisposeBag()
    let disposeBag = DisposeBag()
    //: var count = 0
    var count = 0
    //: open weak var delegate: EditPhotoDelegate?
    open weak var delegate: StopPhotoDelegate?
...
//        showMessageView()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kCheerName.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var titleBLB: UILabel = {
        ...
        lb.textColor = UIColor(hex: (String(dreamDelayWelcomeUrl)))
        //: lb.text = "My photos".localized
        lb.text = (String(showDetailedId)).localized
    ...
    lazy var messageLB: UILabel = {
        ...
        lb.font = UIFont.concern(type: .Regular, fontSize: 12)
        //: lb.textColor = UIColor.init(hex: "#999999")
        lb.textColor = UIColor(hex: (noti_mustStr.capitalized + mainFailFormat.replacingOccurrences(of: "input", with: "9")))
        //: lb.text = "Click to change or delete photo.".localized
        lb.text = String(bytes: dreamSuperiorKeyFormat.map{pokeTear(size: $0)}, encoding: .utf8)!.localized
        //: return lb
        return lb
        //: }()
    }()
...
extension BlackAndWhitePhysicalThen {
    ...
    func can() {
        ...
        for i in 0 ..< 9 {
            ...
            colorBtn.setBackgroundImage(.verbalDescription(name: (String(noti_presentTitle) + String(mainLabUrl.prefix(4)) + "oto_" + String(app_formerGlobalTemplateId.prefix(7)))), for: .normal)
            //: colorBtn.setBackgroundImage(.BundleImageNamed(name: "btn_me_edit_photo_add_pre"), for: .highlighted)
            colorBtn.setBackgroundImage(.verbalDescription(name: (String(user_rationalFormat.suffix(7)) + String(mDistantData) + String(showSimultaneouslyUrl.suffix(5)) + "hoto_" + String(app_followStandardData.prefix(7)))), for: .highlighted)
            ...
            deleteBtn.setBackgroundImage(.verbalDescription(name: (String(app_darkData.suffix(6)) + "_edit_" + m_wayName.lowercased() + String(showCalculateMessage.prefix(7)))), for: .normal)
    ...
    @objc func stroke(sender: UIButton) {
        //: var isReturn = false
        var isReturn = false
        ...
        SatelliteThen.recognizeSource(true) { (isOpen: Bool) in
            ...
            if isOpen {
                ...
                let vc = SmallPickTool.phoneFile(maxCount: 9 - self.count, allowPhoto: true, allowVideo: false)
    ...
    @objc func sender(sender: UIButton) {
        ...
        self.delegate?.rackUpInBeefcake(superBtn.imageView?.image ?? UIImage())

        //: self.delegate?.deletePhotoWithUid(String(superBtn.tag))
        self.delegate?.pair(String(superBtn.tag))
    ...
    func ready(selete: [ValueAttemptGalleryModel]) {
        ...
        for i in 0 ..< selete.count {
            ...
            if i < allPhoto.count {
                ...
                if selete[i].isLocal {
                    ...
                    Btn.attentionStateSoil(urlStr: selete[i].url)
                }
                //: _ = Btn.subviews.map { view in
                _ = Btn.subviews.map { view in
                    //: if (view is UIButton) {
