...
/*: "detection" :*/
fileprivate let userExposureIdent:[Character] = ["d","e","t","e","c","t","i","o","n"]

/*: "aiff" :*/
fileprivate let user_quitItsName:String = "aidiscourse"
...
class SocialRowThen: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = SocialRowThen()
    ...
    func freshBubble() {
        ...
        let soundFilePath = EffectTool.default.coOccurWith(name: (String(userExposureIdent)), type: (user_quitItsName.replacingOccurrences(of: "discourse", with: "ff")))
