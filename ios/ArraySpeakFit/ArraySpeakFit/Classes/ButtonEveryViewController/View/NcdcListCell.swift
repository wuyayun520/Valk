...
fileprivate let app_threadId:[UInt8] = [0xb6,0xb1,0xb6,0xab,0xf7,0xbc,0xb0,0xbb,0xba,0xad,0xe5,0xf6,0xff,0xb7,0xbe,0xac,0xff,0xb1,0xb0,0xab,0xff,0xbd,0xba,0xba,0xb1,0xff,0xb6,0xb2,0xaf,0xb3,0xba,0xb2,0xba,0xb1,0xab,0xba,0xbb]

private func dismissThan(story num: UInt8) -> UInt8 {
    return num ^ 223
}

/*: "icon_home_boy" :*/
fileprivate let dreamShotShadowIdent:[Character] = ["i","c","o","n","_","h"]
fileprivate let mainResultSupportTitle:[Character] = ["o","m","e","_","b","o","y"]

/*: "icon_home_girl" :*/
fileprivate let app_itData:String = "line page beam smoothicon_h"
fileprivate let mainLengthPhaseMsg:[Character] = ["o","m","e","_","g","i","r","l"]
...
class NcdcListCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_threadId.map{dismissThan(story: $0)}, encoding: .utf8)!)
    }
...
extension NcdcListCell {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func greetCan(model: DamnHandyJSON, type: MoveNameQuantityerpolation) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.verbalDescription(name: (String(dreamShotShadowIdent) + String(mainResultSupportTitle))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.verbalDescription(name: (String(app_itData.suffix(6)) + String(mainLengthPhaseMsg))), for: .normal)
        //: break
        //: default:
        default:
            //: break
