...
fileprivate let show_collectionStr:[UInt8] = [0xa8,0xaf,0xa8,0xb5,0xe9,0xa2,0xae,0xa5,0xa4,0xb3,0xfb,0xe8,0xe1,0xa9,0xa0,0xb2,0xe1,0xaf,0xae,0xb5,0xe1,0xa3,0xa4,0xa4,0xaf,0xe1,0xa8,0xac,0xb1,0xad,0xa4,0xac,0xa4,0xaf,0xb5,0xa4,0xa5]

private func boxOrigin(supposed num: UInt8) -> UInt8 {
    return num ^ 193
}

/*: "#292929" :*/
fileprivate let dreamHamText:String = "#quietly9quietly9quietly9"

/*: "9999999" :*/
fileprivate let userIgnoreSiblingText:[Character] = ["9","9","9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let m_structureMsg:String = "icon_ctrue clean"
fileprivate let user_eliteUrl:[Character] = ["o","i","n"]

/*: "icon_gift_more_arrow" :*/
fileprivate let showBadKey:String = "icjackn"
fileprivate let kEveryoneUrl:String = "more_agender my"

/*: "Hot" :*/
fileprivate let appDiscSweepFormat:[Character] = ["H","o","t"]

/*: "VIP" :*/
fileprivate let m_disappearPath:String = "originalIP"

/*: "Bags" :*/
fileprivate let userSkipUrl:[Character] = ["B","a","g","s"]

/*: "icon_gift_num_arrow" :*/
fileprivate let showUniversalMsg:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u","m","_","a","r","r","o","w"]

/*: "Send" :*/
fileprivate let userLevelTitle:[Character] = ["S","e","n","d"]

/*: "nav_back_black_nor" :*/
fileprivate let m_banKey:String = "yourself"
fileprivate let m_makerKey:[Character] = ["a","v","_","b","a","c","k","_","b","l","a","c","k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let mSeemId:[UInt8] = [0xdb,0xe7,0xea,0xaf,0xe1,0xfa,0xe2,0xed,0xea,0xfd,0xaf,0xe0,0xe9,0xaf,0xe8,0xe6,0xe9,0xfb,0xfc,0xaf,0xec,0xee,0xe1,0xe1,0xe0,0xfb,0xaf,0xed,0xea,0xaf,0xe3,0xea,0xfc,0xfc,0xaf,0xfb,0xe7,0xee,0xe1,0xaf,0xbe]

private func payingAttention(invite num: UInt8) -> UInt8 {
    return num ^ 143
}

/*: "Please select a gift" :*/
fileprivate let dreamSharedIdent:String = "Pleaparent shared"
fileprivate let dream_movieContent:[Character] = ["e","c","t"," ","a"," ","g","i","f","t"]

/*: "Please select an object" :*/
fileprivate let mainOpenlyUrl:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c","t"," ","a","n"," "]
fileprivate let main_springUrl:[Character] = ["o","b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let main_incorporateKey:[UInt8] = [0xf1,0x3,0xa,0x3,0x1,0x12,0xbe,0x12,0x6,0x3,0xbe,0x2,0x3,0x11,0x7,0x10,0x3,0x2,0xbe,0x5,0x7,0x4,0x12,0xbe,0x12,0xd,0xbe,0x13,0xc,0xa,0xd,0x1,0x9]

fileprivate func spaceClothes(headline num: UInt8) -> UInt8 {
...
/*: "Select object >" :*/
fileprivate let dream_darkId:String = "green pad goalSele"
fileprivate let notiViaName:String = "ct obstructure attitude"

/*: "It looks like there's nothing" :*/
fileprivate let user_followId:String = "It looksfoundation incorporate length power"
fileprivate let k_discKey:String = "damn compare dynamics l"
fileprivate let k_adMessage:String = "magnitude comply asike t"
fileprivate let user_acrossSuspendId:String = "\'s not"

/*: "FF75A4" :*/
fileprivate let main_sinceMessage:[Character] = ["F","F","7","5","A","4"]

/*: "E570FF" :*/
fileprivate let k_calendarEngineName:String = "E570which"

/*: "Ask for" :*/
fileprivate let showPendingDewName:[Character] = ["A","s","k"," ","f"]
fileprivate let mMultipleStr:String = "OR"

/*: " Select %@ > " :*/
fileprivate let notiSecondName:String = "tube soil goal Sele"
fileprivate let noti_masterMessage:String = " > "

/*: "All Numbers" :*/
fileprivate let userVarietyMsg:String = "when audience cute decisionAll "

/*: "View detailed description >" :*/
fileprivate let m_partyKey:String = "View today for minimize"
fileprivate let dreamFeverIdent:String = "population tryiled "
fileprivate let m_sharpUnableId:String = "iption >honor skin theme plan"

/*: "9999" :*/
fileprivate let kCuteCountroUrl:String = "9999"

/*: "Custom" :*/
fileprivate let kReadFlatFormat:[Character] = ["C","u","s","t","o","m"]

/*: "mf_coin" :*/
fileprivate let appTabUrl:String = "mf_coblue dimension mix sweet"
fileprivate let notiRhythmIdent:[Character] = ["i","n"]

/*: "showBagsRed" :*/
fileprivate let main_dotStr:String = "transmission pull domain importantshowBag"
fileprivate let app_civicBadKey:String = "shared comprehensive slipsRed"
...
enum PipSqueakEquatable: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
enum ComprehensiveTextConvertible: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: BoltHandyJSON, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: BoltHandyJSON, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: BoltHandyJSON) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: BoltHandyJSON, _ num: String, _ model: DamnHandyJSON) -> Void
// 隐藏礼物面板Block
...
private let main_networkIdent = 44.0
//: let GiftScrollContentView_H = 252.0
let user_iconQuantityUrl = 252.0
//: private let pageControl_H = 7.0
private let userAgentPackagePath = 7.0
//: private let bottomView_H = 44.0
private let kGiftPageMessage = 44.0

//: class TalkingChatGiftView: UIView {
class WrongViewDelegate: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = main_networkIdent + user_iconQuantityUrl + userAgentPackagePath + kGiftPageMessage + user_sizeValue
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [ComprehensiveTextConvertible]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = ComprehensiveTextConvertible.Hot
    ...
    init(frame: CGRect = .zero, style: PipSqueakEquatable = .normal, titlesArr: [ComprehensiveTextConvertible] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_collectionStr.map{boxOrigin(supposed: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: user_allMessage, width: kGiftIdent, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (dreamHamText.replacingOccurrences(of: "quietly", with: "2")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.shRadii(width: kGiftIdent, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: kGiftIdent, height: main_networkIdent)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (dreamHamText.replacingOccurrences(of: "quietly", with: "2")))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: GoddamnThen = {
        //: let btn = TalkingButton()
        let btn = GoddamnThen()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.concern(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((String(userIgnoreSiblingText)), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.verbalDescription(name: (String(m_structureMsg.prefix(6)) + String(user_eliteUrl))), for: .normal)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.verbalDescription(name: (showBadKey.replacingOccurrences(of: "jack", with: "o") + "_gift_" + String(kEveryoneUrl.prefix(6)) + "rrow"))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.optimize(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.optimize(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        let layout = ComparableStuffReactiveCompatible()
        ...
        hot.register(EliteGroupThen.self, forCellWithReuseIdentifier: EliteGroupThen.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: ComparableStuffReactiveCompatible = //: return hotGiftCollectionView.collectionViewLayout as! ComparableStuffReactiveCompatible
        hotGiftCollectionView.collectionViewLayout as! ComparableStuffReactiveCompatible
    //: }()
    ...
    private lazy var titleScrollView: PresenceReactiveCompatible = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(appDiscSweepFormat)).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((m_disappearPath.replacingOccurrences(of: "original", with: "V")).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(userSkipUrl)).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = WrittenMaterialBoltWaySegmentStyle()
        ...
        let scrollview = PresenceReactiveCompatible(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(main_networkIdent)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if SolidUntilLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = ImmediatelyThen.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = ImmediatelyThen.poundWidthGet() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !FriendshipBoltGiftManager.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        ...
        view.layer.borderColor = UIColor.storageEngine().cgColor
    ...
    private lazy var giftNumButton: GoddamnThen = {
        ...
        btn.setImage(UIImage.verbalDescription(name: (String(showUniversalMsg))), for: .normal)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.concern(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.storageEngine()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(userLevelTitle)).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(immobilize), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: user_allMessage - CGFloat(keyborHeight) - 44, width: kGiftIdent, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.verbalDescription(name: (m_banKey.replacingOccurrences(of: "yourself", with: "n") + String(m_makerKey))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.inviteLicense(color: .storageEngine(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(userLevelTitle)).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.changeManage(showMsg: String(bytes: mSeemId.map{payingAttention(invite: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.changeManage(showMsg: (String(dreamSharedIdent.prefix(4)) + "se sel" + String(dream_movieContent)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.changeManage(showMsg: (String(mainOpenlyUrl) + String(main_springUrl)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = ComprehensiveTextConvertible(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.announcementVariety(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: BoltHandyJSON = dataArr[index] as! BoltHandyJSON
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.storageEngine()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(conserveAgain(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(willRender(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(byRefuse(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: main_incorporateKey.map{spaceClothes(headline: $0)}, encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(roleMax), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(dream_darkId.suffix(4)) + String(notiViaName.prefix(5)) + "ject >").localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(quote), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(blindAnima), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.concern(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(user_followId.prefix(8)) + String(k_discKey.suffix(2)) + String(k_adMessage.suffix(5)) + "here" + user_acrossSuspendId + "hing").localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.gravitySize(colors: [UIColor(hex: (String(main_sinceMessage)))!.cgColor, UIColor(hex: (k_calendarEngineName.replacingOccurrences(of: "which", with: "FF")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.concern(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(showPendingDewName) + mMultipleStr.lowercased()).localized, for: .normal)
...
extension WrongViewDelegate {
    /// 隐藏视图
    //: @objc func dismissView() {
    @objc func blockPosition() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: user_allMessage, width: kGiftIdent, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    /// 展示视图
    //: func showView() {
    func phosphoresceAndViewEffect() {
        //: UIView.animate(withDuration: 0.3, animations: {
        UIView.animate(withDuration: 0.3, animations: {
            //: self.alpha = 1.0
            self.alpha = 1.0
            //: self.contentView.frame = CGRect(x: 0, y: ScreenHeight-self.contentHeight, width: ScreenWidth, height: self.contentHeight)
            self.contentView.frame = CGRect(x: 0, y: user_allMessage - self.contentHeight, width: kGiftIdent, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func roleMax() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = ComprehensiveTextConvertible(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.announcementVariety(dataType: dataType)
    ...
    @objc func quote() {
        ...
        meneView = FriendshipDataSource(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func blindAnima() {
        //: dismissView()
        blockPosition()
        //: PipSqueakReactiveCompatible.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        PipSqueakReactiveCompatible.share.circleResolution(webViewType: .luckyBlindBox)
    }
...
extension WrongViewDelegate {
    ...
    func nm(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.announcementVariety(dataType: self.currType) as! [BoltHandyJSON]
            // 找到当前背包礼物索引，更新数量
            ...
            FriendshipBoltGiftManager.share.trailheadArr(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.zone(force: true)
        }
    }
}

// MARK: - AllowViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension WrongViewDelegate: AllowViewDelegate {
    ...
    func distanceModel(model: DamnHandyJSON) {
        ...
        seleteObjectBtn.setTitle((String(notiSecondName.suffix(5)) + "ct %@" + noti_masterMessage.capitalized).launchRid(model.nickname), for: .normal)
    }
    ...
    func below() {
        ...
        if model.nickname == (String(userVarietyMsg.suffix(4)) + "Numbers").localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! DamnHandyJSON
    ...
    func row(title: String) {
        ...
        let str = (String(m_partyKey.prefix(5)) + "deta" + String(dreamFeverIdent.suffix(5)) + "descr" + String(m_sharpUnableId.prefix(8))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension WrongViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func announcementVariety(dataType: ComprehensiveTextConvertible) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return FriendshipBoltGiftManager.share.publisher(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func motivation() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return FriendshipBoltGiftManager.share.fleet()
    }
    ...
    func threshold(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == PresenceEquatable.myStery.rawValue)
        }
        ...
        hotGiftLayout.hotDataArr = announcementVariety(dataType: .Hot)
        //: hotGiftLayout.vipDataArr = getGiftData(dataType: .Vip)
        hotGiftLayout.vipDataArr = announcementVariety(dataType: .Vip)
        //: hotGiftLayout.bagsDataArr = getGiftData(dataType: .Bags)
        hotGiftLayout.bagsDataArr = announcementVariety(dataType: .Bags)
    ...
    @objc fileprivate func conserveAgain(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (kCuteCountroUrl.capitalized)
            //: } else {
        } else {
    ...
    @objc func byRefuse(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: user_allMessage - CGFloat(keyborHeight) - 44, width: kGiftIdent, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func willRender(notification _: NSNotification) {
    ...
    func moveField() {
        ...
        let sendingItems = motivation()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(listenerCurrent(index: i))
//            let giftNumArrModel: GiftRoofHandyJSON = sendingItems[i] as! GiftRoofHandyJSON
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(kReadFlatFormat)).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.CompartmentMatter.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = RoofDataSource.untilVisible(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func empty() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? EliteGroupThen
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.warningClub(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = ComprehensiveTextConvertible(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = announcementVariety(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = EliteGroupThen.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! EliteGroupThen
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = ComprehensiveTextConvertible(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = announcementVariety(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: BoltHandyJSON = dataArr[indexPath.row] as! BoltHandyJSON
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.supply(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.my(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = ComprehensiveTextConvertible(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = announcementVariety(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == PresenceEquatable.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == PresenceEquatable.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == PresenceEquatable.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                spendContent(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = multi(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = by(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            spendContent(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: EliteGroupThen = giftSelectedModel.lastHotCell as! EliteGroupThen
                //: cell.setChecked(checked: false)
                cell.my(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: EliteGroupThen = self.hotGiftCollectionView.cellForItem(at: indexPath) as! EliteGroupThen
            //: currentCell.setChecked(checked: true)
            currentCell.my(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.forte(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.announcementVariety(dataType: self.currType)
    ...
    func zone(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + kGiftIdent
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < kGiftIdent ? kGiftIdent : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / kGiftIdent - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(kGiftIdent) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = ComprehensiveTextConvertible.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = FriendshipBoltGiftManager.share.tillCur(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.representation(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && AppManager.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == ComprehensiveTextConvertible.Hot && self.style == .normal && AppManager.share.loginUserMode.sex == AlongsideDigitalTableConvertible.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == PresenceEquatable.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                row(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func draft() {
        ...
        self.giftSelectedModel = MortalityMeasurable()
...
extension WrongViewDelegate: LineViewDelegate {
    ...
    func speakLikeHeader(index: Int, title: String) {
        ...
        spendContent(index: index + 1, title: title)
    }

    //: func  didClickSelectedCellRow(index: Int, title: String) {
    func spendContent(index: Int, title _: String) {
        //: let numberOfGift = numberOfGiftForIndex(index: index)
        let numberOfGift = listenerCurrent(index: index)
        //: if numberOfGift>0 {
        if numberOfGift > 0 {
            ...
            popView?.innerView(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.viewEffect(view: self.window!)
    ...
    func listenerCurrent(index: Int) -> Int {
        //: let sendingItems = giftSendItems()
        let sendingItems = motivation()
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: GiftRoofHandyJSON = sendingItems[index] as! GiftRoofHandyJSON
    ...
    func multi(num: Int) -> Int {
        ...
        for i in 0 ..< motivation().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: GiftRoofHandyJSON = motivation()[i] as! GiftRoofHandyJSON
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func by(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > motivation().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension WrongViewDelegate {
    ...
    private func panel() {
        ...
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: kGiftIdent, height: user_allMessage - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(blockPosition)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(user_iconQuantityUrl)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(kGiftIdent)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(kGiftIdent - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(userAgentPackagePath)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(kGiftPageMessage)
        }
    ...
    private func larva() {
        ...
        AppManager.share.loginUserMode.rx
            ...
            .observeWeakly(String.self, (String(appTabUrl.prefix(5)) + String(notiRhythmIdent)))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.threshold(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        FriendshipBoltGiftManager.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(main_dotStr.suffix(7)) + String(app_civicBadKey.suffix(4))))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                FriendshipBoltGiftManager.share.funcByCompletion(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: AppManager.share.loginUserMode.mf_coin)
                    self.threshold(needReload: true, mf_coin: AppManager.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
