...
open class KindReactiveCompatible: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = KindReactiveCompatible.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func placeholderGenerate() {
