...
/*: "&sr=6" :*/
fileprivate let k_effectData:[Character] = ["&","s","r","=","6"]
...
enum TransitCaseIterable: String, CaseIterable {
...
enum CharacterSubqueryConvertible: String {
...
class AlongsideManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func mediumBoard(urlType: CharacterSubqueryConvertible) -> String {
        ...
        case .RechargeToVideoInitivHalfPage:
            ...
            let newstr = AppManager.share.appUserConfigMode.halfRechargePage.appending((String(k_effectData)))
