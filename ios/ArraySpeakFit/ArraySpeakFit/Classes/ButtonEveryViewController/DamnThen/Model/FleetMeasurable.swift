...
class FleetMeasurable: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = JournalHandyJSON() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [AffiliatedPeopleModelMeasurable]() // 游戏列表
...
class JournalHandyJSON: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var headPic = ""
    var headPic = ""
...
class AffiliatedPeopleModelMeasurable: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
