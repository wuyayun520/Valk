...
let dreamPurchaseStr = actualWidth(w: 275)
//: let MsgTableViewHeight =  actualWidth(w: 200)
let mGreetIdent = actualWidth(w: 200)
//: let cellLineSpeing = 3
let m_plainName = 3 /// cell间距

//: struct TalkingLiveRoomDanmuModel: HandyJSON {
struct PhysicalModelType: HandyJSON {
    //: var msgInfo: TalkingDanmuMsgInfo?
    var msgInfo: DamnMsgInfo?
    //: var user: TalkingDanmuUserInfo?
    var user: MoveTransformable?
    //: var gift: TalkingGiftMsgAnimatModel?
    var gift: ErrTransformable?
    //: var toUser: TalkingDanmuUserInfo?
    var toUser: MoveTransformable?
...
struct MoveTransformable: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""
