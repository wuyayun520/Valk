...
// __CLOSE_PRINT__
//
//  LicenseTailTransformable.swift
//
...
let user_storageValue = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let mainMicId = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let showMeKey = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct LicenseTailTransformable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
