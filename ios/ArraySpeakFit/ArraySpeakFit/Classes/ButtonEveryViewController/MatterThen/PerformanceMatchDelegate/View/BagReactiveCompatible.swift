...
fileprivate let mFormRobotMsg:[UInt8] = [0x42,0x47,0x42,0x4d,0x1,0x3c,0x48,0x3d,0x3e,0x4b,0x13,0x2,0xf9,0x41,0x3a,0x4c,0xf9,0x47,0x48,0x4d,0xf9,0x3b,0x3e,0x3e,0x47,0xf9,0x42,0x46,0x49,0x45,0x3e,0x46,0x3e,0x47,0x4d,0x3e,0x3d]

fileprivate func priorityAcquire(background num: UInt8) -> UInt8 {
...
/*: "#E6BD8B" :*/
fileprivate let main_cuteId:[Character] = ["#","E","6","B","D","8","B"]

/*: "get json error" :*/
fileprivate let userCheatHostOppositeData:String = "added pocket abstract surgery originalget js"
fileprivate let m_mapData:[Character] = ["o","r"]
...
class BagReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mFormRobotMsg.map{priorityAcquire(background: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.concern(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (String(main_cuteId)))
...
extension BagReactiveCompatible {
    //: func setPointData(point: String, isminiStr: Bool = false) {
    func attracter(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(main_cuteId)))!, .font: UIFont.concern(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (String(main_cuteId)))!, .font: UIFont.concern(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = EffectTool.default.variationType(type: .VideoCall_femalePoint)
            ...
            if SweepAddrTool.share.interfaceLang == RowTitleTotalerpolation.ar.rawValue {
                ...
                url = EffectTool.default.variationType(type: .videoCall_femalePoint_ar)
                ...
                url = EffectTool.default.variationType(type: .videoCall_femalePoint_es)
                ...
                url = EffectTool.default.variationType(type: .videoCall_femalePoint_pt)
            }
            ...
            printLog(message: (String(userCheatHostOppositeData.suffix(6)) + "on err" + String(m_mapData)))
        }
    }
}
