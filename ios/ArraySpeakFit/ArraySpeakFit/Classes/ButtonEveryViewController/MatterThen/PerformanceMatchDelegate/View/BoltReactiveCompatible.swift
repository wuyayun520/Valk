...
fileprivate let k_clearlyMessage:[UInt8] = [0x5c,0x5b,0x5c,0x41,0x1d,0x56,0x5a,0x51,0x50,0x47,0xf,0x1c,0x15,0x5d,0x54,0x46,0x15,0x5b,0x5a,0x41,0x15,0x57,0x50,0x50,0x5b,0x15,0x5c,0x58,0x45,0x59,0x50,0x58,0x50,0x5b,0x41,0x50,0x51]

private func brigOutside(vessel num: UInt8) -> UInt8 {
    return num ^ 53
}

/*: "icon_livetc_warn" :*/
fileprivate let show_correctIdent:String = "icon_lcenter go chin"
fileprivate let user_localDivisionKey:[Character] = ["c","_","w","a","r","n"]
...
class BoltReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_clearlyMessage.map{brigOutside(vessel: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.verbalDescription(name: (String(show_correctIdent.prefix(6)) + "ivet" + String(user_localDivisionKey)))
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(moveShirtButtonRight), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension BoltReactiveCompatible {
    //: func show() {
    func micShow() {
    ...
    @objc private func moveShirtButtonRight() {
        //: dismiss()
        closed()
    }
}
