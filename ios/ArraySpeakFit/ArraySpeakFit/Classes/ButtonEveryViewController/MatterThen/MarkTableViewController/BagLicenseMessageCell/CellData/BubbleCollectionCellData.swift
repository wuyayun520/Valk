...
/*: ".png" :*/
fileprivate let dreamDewValue:[Character] = [".","p","n","g"]
...
// __CLOSE_PRINT__
//
//  BubbleCollectionCellData.swift
//  AbroadTalking
//
...
//: @objcMembers public class BubbleCollectionCellData: TalkingChatMsgBaseCellData {
@objcMembers public class BubbleCollectionCellData: OthersAlterCellData {
    ...
    override public var msgModel: DramaticallyModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.amongExpected(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func drawnOut(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(k_lineWithoutTitle)
        ...
        let imageName = "\(Int(interval))_" + AppManager.share.loginUserMode.userID + (String(dreamDewValue))
        ...
        let imageData = UIImage.intervalernalRepresentation(image, sample: 2 * 1024)
