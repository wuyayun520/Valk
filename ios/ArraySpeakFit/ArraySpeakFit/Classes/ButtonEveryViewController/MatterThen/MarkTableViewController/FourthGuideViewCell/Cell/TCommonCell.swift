...
@objcMembers public class AccountingDataThen: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func discount(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class PhysicalTableViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: AccountingDataThen?
    ...
    @objc dynamic public func tip(with data: AccountingDataThen) {
        //: self.data = data
        self.data = data
    }
} 
