 ...
 * 消息翻译状态
 */
//: @objc public enum MailStrideable: UInt {
@objc public enum MailStrideable: UInt {
...
@objc public enum AbsenceWidthTotal: UInt {
...
// MARK: - ProjectionCellData

/**
 * 【模块名称】ProjectionCellData
 ...
 */
//: @objcMembers public class ProjectionCellData: TCommonCellData {
@objcMembers public class ProjectionCellData: AccountingDataThen {
    ...
    public var direction: AbsenceWidthTotal = .MsgDirectionIncoming
    ...
    //: public var translateStatus: MailStrideable = .MsgTranslate_init
    public var translateStatus: MailStrideable = .MsgTranslate_init
    ...
    public var msgModel: DramaticallyModel = DramaticallyModel()
    ...
    public var cellLayout: LayoutReactiveCompatible!
    ...
    public init(direction: AbsenceWidthTotal) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.damage()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = LayoutReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = LayoutReactiveCompatible(isIncomming: false)
    ...
    public override func discount(_ width: CGFloat) -> CGFloat {
