...
// __CLOSE_PRINT__
//
//  LayoutReactiveCompatible.swift
//  ArraySpeakFit
//
...
@objcMembers public class LayoutReactiveCompatible: NSObject {
    ...
    class func lyric() -> LayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = LayoutReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func installmentDown() -> LayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = LayoutReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func layout() -> LayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = LayoutReactiveCompatible.init(isIncomming: false)
    ...
    class func deadlinePath() -> LayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = LayoutReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func scale() -> LayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = LayoutReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
