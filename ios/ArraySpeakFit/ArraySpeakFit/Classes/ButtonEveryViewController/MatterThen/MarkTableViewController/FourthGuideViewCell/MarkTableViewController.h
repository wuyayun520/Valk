 ...
 *
 *  DelegateDirty 协议和 MarkTableViewController 类。
 *  MarkTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 MarkTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class MarkTableViewController;
//: @class FourthGuideViewCell;
@class FourthGuideViewCell;
//: @class ProjectionCellData;
@class ProjectionCellData;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
@protocol DelegateDirty <NSObject>
...
- (void)userred:(MarkTableViewController *)controller;
...
- (void)doingFrom:(MarkTableViewController *)controller;
...
- (BOOL)border:(MarkTableViewController *)controller supply:(UIView *)view;
 ...
 */
//: - (ProjectionCellData *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (ProjectionCellData *)frameAsk:(MarkTableViewController *)controller enable:(V2TIMMessage *)data;
 ...
 */
//: - (FourthGuideViewCell *)messageController:(TUIMessageController *)controller onShowMessageData:(ProjectionCellData *)data;
- (FourthGuideViewCell *)income:(MarkTableViewController *)controller format:(ProjectionCellData *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(FourthGuideViewCell *)cell;
- (void)sendAvatar:(MarkTableViewController *)controller communicationAvatarDestroyAlongSelectDedication:(FourthGuideViewCell *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(FourthGuideViewCell *)cell;
- (void)changeDescription:(MarkTableViewController *)controller kindForText:(FourthGuideViewCell *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(ProjectionCellData *)data;
- (void)circle:(MarkTableViewController *)controller response:(NSInteger)menuType send:(ProjectionCellData *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(FourthGuideViewCell *)cell;
- (void)controller:(MarkTableViewController *)controller factorTitle:(FourthGuideViewCell *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(ProjectionCellData *)cellData;
- (void)process:(MarkTableViewController *)controller telegram:(ProjectionCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(ProjectionCellData *)cellData;
- (void)infix:(MarkTableViewController *)controller without:(ProjectionCellData *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         MarkTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】MarkTableViewController
...
/**
 *  执行 DelegateDirty 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<DelegateDirty> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<ProjectionCellData *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成ProjectionCellData
 */
