...
fileprivate let noti_goalName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class AllowReactiveCompatible: LaborView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_goalName.reversed(), encoding: .utf8)!)
    }
    ...
    override func tillShould() {
        ...
        let filePath = RelatedAnimatTool.shared.trademarkDatabaseModel(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.premium(effectItemView: self, success: true)
...
extension AllowReactiveCompatible: SVGAPlayerDelegate {
