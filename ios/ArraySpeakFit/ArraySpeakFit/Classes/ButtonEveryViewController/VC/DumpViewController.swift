...
/*: "#777777" :*/
fileprivate let m_minFormat:String = "#7777"
fileprivate let m_vidStr:String = "77"

/*: "#333333" :*/
fileprivate let notiSpeculateId:String = "#333333"

/*: "Followers" :*/
fileprivate let appChallengeIdent:[Character] = ["F","o","l","l","o","w","e","r","s"]

/*: "Following" :*/
fileprivate let noti_extendedFormat:[Character] = ["F","o","l","l","o","w","i","n","g"]

/*: "nav_back_black_nor" :*/
fileprivate let kVariationPath:String = "apply standnav_ba"
fileprivate let dream_levelName:String = "NOR"
...
class DumpViewController: FictionalCharacterRecognizerDelegate {
    //: var currentIndex = 0
    var currentIndex = 0
...
//        segmentedDataSource.itemSpacing = 0
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (m_minFormat.capitalized + m_vidStr.capitalized))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (notiSpeculateId.capitalized))!
        ...
        indicator.indicatorColor = UIColor(hex: (notiSpeculateId.capitalized))!
    ...
    private lazy var titleArray: [String] = //: return ["Followers".localized, "Following".localized]
        [(String(appChallengeIdent)).localized, (String(noti_extendedFormat)).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [FictionalCharacterRecognizerDelegate] = //: return [FaceViewDelegate(), RelatedJournalViewController()]
        [FaceViewDelegate(), RelatedJournalViewController()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.verbalDescription(name: (String(kVariationPath.suffix(6)) + "ck_black_" + dream_levelName.lowercased())).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(tillBack), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension DumpViewController: JXSegmentedViewDelegate {
...
extension DumpViewController: JXPagingViewDelegate {
