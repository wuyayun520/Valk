...
/*: "App" :*/
fileprivate let showGuidanceUrl:String = "wife netApp"

/*: "blockList_ :*/
fileprivate let dreamSatisfyId:String = "blockLisrevolution con brig"
fileprivate let show_twoContent:[Character] = ["t","_"]
...
class PoThen: NSObject {
    ...
    func betweenProgram(userId: String) {
    ...
    func session(userId: String) -> Bool {
    ...
    private func endRun() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(showGuidanceUrl.suffix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(dreamSatisfyId.prefix(8)) + String(show_twoContent)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
