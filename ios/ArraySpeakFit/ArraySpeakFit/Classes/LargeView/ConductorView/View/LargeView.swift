...
fileprivate let app_digitalExecData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
enum RouteCaseIterable: CaseIterable {
    //: case Left
    case Left
    //: case Right
    case Right
...
class LargeView: UIView {
    ...
    var cell_delegate: PreviouslyObjectProtocol?

    //: var model: TalkingMatchResultModel?
    var model: EditParentModelType?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_digitalExecData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(obliqueAngle(pan:)))
        //: v.delegate = self
        v.delegate = self
        //: return v
        return v
...
extension LargeView: UIGestureRecognizerDelegate {
    ...
    @objc func obliqueAngle(pan: UIPanGestureRecognizer) {
        //: switch pan.state {
        switch pan.state {
        //: case .began:
        case .began:
        ...
        case .changed:
            ...
            if SolidUntilLanguageManager.shared.direction == .rightToLeft {
                ...
                if movePoint.x > kGiftIdent / 4 {
                    ...
                    self.cell_delegate?.cellPoint(cell: self, forMovePoint: self.currentPoint)
    ...
    func teammate() {
        ...
        self.cell_delegate?.amazingDisclose(cell: self)
    }
    ...
    func fromAppropriate(direction: RouteCaseIterable) {
        //: switch (direction) {
        switch direction {
        //: case .Left:
        case .Left:
