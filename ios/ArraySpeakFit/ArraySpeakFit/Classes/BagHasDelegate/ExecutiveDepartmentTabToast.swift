...
fileprivate let showGoalTitle:[UInt8] = [0xba,0xbd,0xba,0xa7,0xfb,0xb0,0xbc,0xb7,0xb6,0xa1,0xe9,0xfa,0xf3,0xbb,0xb2,0xa0,0xf3,0xbd,0xbc,0xa7,0xf3,0xb1,0xb6,0xb6,0xbd,0xf3,0xba,0xbe,0xa3,0xbf,0xb6,0xbe,0xb6,0xbd,0xa7,0xb6,0xb7]

/*: "btn_live_toast_bg" :*/
fileprivate let dream_timingOthersName:[Character] = ["b","t","n","_","l","i","v","e","_","t","o","a","s"]
fileprivate let noti_childPositivePath:String = "warn mouth labelt_bg"

/*: "btn_live_toast_arrow" :*/
fileprivate let mUnlessData:String = "btn_status strength hesitate yellow object"
fileprivate let k_distributionUrl:String = "differenceast"
...
// __CLOSE_PRINT__
//
//  ExecutiveDepartmentTabToast.swift
//  AbroadTalking
//
...
var dreamPingKey = false

//: class TalkingLiveTabToast: UIView {
class ExecutiveDepartmentTabToast: UIView {
    // 气泡间距
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showGoalTitle.map{$0^211}, encoding: .utf8)!)
    }
    ...
    private lazy var bubbleImgView: UIImageView = {
        ...
        var img = UIImage.verbalDescription(name: (String(dream_timingOthersName) + String(noti_childPositivePath.suffix(4)))).resizableImage(withCapInsets: bubbleInsets, resizingMode: .stretch)
        //: imgV.image = img
        imgV.image = img
        //: return imgV
        return imgV
    ...
    private lazy var arrowImgView: UIImageView = {
        ...
        imgV.image = UIImage.verbalDescription(name: (String(mUnlessData.prefix(4)) + "live_t" + k_distributionUrl.replacingOccurrences(of: "difference", with: "o") + "_arrow"))
        //: return imgV
        return imgV
        //: }()
    }()
...
extension ExecutiveDepartmentTabToast {
    /// 展示视图，5s后自动移除
    //: func show(superView: UIView) {
    func tipView(superView: UIView) {
        //: guard LIVETABTOASTISSHOW == false else { return }
        guard dreamPingKey == false else { return }
