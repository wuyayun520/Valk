...
Pod::Spec.new do |s|
  s.name         = "ArraySpeakFit"
  s.version      = "1.0.0"
  s.summary      = "iOS ArraySpeakFit Module."
  s.author       = { "ArraySpeakFit" => "ArraySpeakFit.me" }
  s.homepage     = "ArraySpeakFit"
  s.source       = { :git => "http://ArraySpeakFit.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'ArraySpeakFit/Classes/**/*'
  s.resources = "ArraySpeakFit/Resources/*.bundle"
  s.vendored_libraries = 'ArraySpeakFit/Classes/**/*.a'
